//
//  UIButton+JWActivityIndicator.m
//  AppKitLibrary
//
...
@implementation UIButton (JWActivityIndicator)


static NSString* const kActivityIndicatorKey = @"ActivityIndicatorKey";
static NSString* const kWokingKey = @"WokingKey";
